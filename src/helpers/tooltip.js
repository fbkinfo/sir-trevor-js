...
/*
 * jQuery Tooltip plugin from @andrewplummer
 * http://andrewplummer.github.io/tooltip/
 * ------
 * adapted to show link hrefs as a tooltip
 */
    ...
    this.each(function() {
      ...
      el.unbind('mouseenter').mouseenter(function() {
        ...
        timer = setTimeout(function() {
          var margin    = getDefault('margin', options, el, 5);
          ...
          var href = el.attr('href');
          // truncate long hrefs
          href = href.length > 100 ? href.substr(0,100) + '…' : href
          setContent(el, options.html || href);
